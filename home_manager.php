				...
				<li class="next-slide">
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='800px' width="1400px" clip-path="url(#cd-image-2)" xlink:href="web_home/images/lohit.jpeg"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
				...
				<li>
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='800px' width="1400px" clip-path="url(#cd-image-3)" xlink:href="web_home/images/iit.jpeg"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
					<div class="cd-radial-slider-content text-center">
						<div class="wrapper">
