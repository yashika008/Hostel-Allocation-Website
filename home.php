...
<header>
	<div class="container agile-banner_nav">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<h1><a class="navbar-brand" href="home.php"><p>IITG</p><span class="display"></span></a></h1>
				...
				<li class="visible">
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='800px' width="1400px" clip-path="url(#cd-image-1)" xlink:href="web_home/images/dhansiri.jpeg"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
				...
				<li class="next-slide">
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='800px' width="1400px" clip-path="url(#cd-image-2)" xlink:href="web_home/images/a.jpg"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
				...
				<li>
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='800px' width="1400px" clip-path="url(#cd-image-3)" xlink:href="web_home/images/lohit.jpeg"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
					<div class="cd-radial-slider-content text-center">
						<div class="wrapper">
